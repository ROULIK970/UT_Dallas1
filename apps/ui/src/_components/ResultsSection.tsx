...
export default function ResultsSection() {
  ...
  fetchArticles(undefined, false, newIsLatest);
  }

  return (
    <>
      {articles.length ? (
        <div className="overflow-auto flex flex-col justify-center items-center mx-auto max-w-[80%] mt-[10em] ">
          <div className="md:flex w-full sticky top-0 z-10 rounded-[14px] border border-gray-200 bg-white shadow-[0_1px_3px_0_rgba(0,0,0,0.10),0_1px_2px_-1px_rgba(0,0,0,0.10)] px-[21.889px] pt-[20.935px] pb-[21.9px]">
            ...
            <div className="flex-[0.3] flex items-center gap-4 md:justify-end">
              ...
              <button onClick={handleRelevance} className="cursor-pointer hover:scale-105 transform transition-all duration-300 ease-in-out rounded-[6.75px] border text-[12.3px] border-[#D1D5DC] bg-white pt-[7.889px] pb-[7.889px] text-[#0A0A0A] pr-[28.28px] pl-[14.94px]">
                Relevance
              </button>
            </div>
          </div>
