...
export default function ResultsSection() {
  ...
  return (
    <>
        ...
        <div className=" flex flex-col justify-center items-center mx-auto max-w-[80%] mt-[10em]">
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-5">
              <p className="text-gray-500 text-[14px]">Loading more articles...</p>
            </div>
          )}
      ...
      <button onClick={scrollToTop} className='cursor-pointer fixed bottom-5 right-5 z-50 text-white text-xl px-4 py-2 rounded bg-green-900 hover:bg-green-800 transform transition-all duration-300 ease-in-out hover:scale-105'>Go to Top</button>
    </>
  )
}
