  ...
  return (
    <div className="md:p-10">
      <div className="lg:px-[100px] md:px-[50px] mt-9">
        <h1 className="text-[#101828] md:text-[32.6px] lg:text-[56px]  font-bold text-[26px] mb-10 px-2.5 leading-[120%]">
          {blog.title}
        </h1>
        <p className="text-gray-600 text-[18px] md:text-[26px] mb-3 px-2.5 leading-[120%]">
          {blog.description}
        </p>
        <p className=" mb-9 font-semibold px-2.5 text-[0.9rem] mt-7">
