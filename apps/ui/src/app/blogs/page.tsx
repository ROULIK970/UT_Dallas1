    ...
    <div className="mb-3 mt-2 md:px-14 px-6">
      <div className="flex flex-col gap-4">
        ...
        <div className="rounded-[14px] border border-[rgba(0,0,0,0.06)] flex flex-col xl:flex-row p-2 md:p-10 gap-5 ">
          <Image
            src={getBlogsInfo.featuredBlog.img}
            alt="featured-img"
            width={695}
            height={725}
          ...
          <div className="flex-[1] flex flex-col gap-6">
            <div className="flex 2xl:gap-5 justify-around ">
              ...
              <div className="flex items-center gap-1">
                ...
                <p className="text-[10px] md:text-[15px]">
                  {getBlogsInfo.featuredBlog.dateOfPublishing}
                </p>
              </div>
              <div className="flex items-center gap-1">
                <Image
            ...
            <h1 className="text-[#101828] text-[18px] md:text-[26.487px]">
              2024 Global Business School Research Rankings: Key Trends and
              Insights
            </h1>
            <p className="text-[#4A5565] text-[14px] md:text-[18px]">
              Comprehensive analysis of this year's rankings reveals significant
              shifts in research excellence, with emerging markets gaining
              ground and traditional leaders adapting to new methodologies.
            </p>
            <div className="flex gap-3">
              ...
              />
              <div>
                <p className="text-[#101828] font-[600] text-[12px] md:text-[17px]">
                  {getBlogsInfo.featuredBlog.blogAuthor}
                </p>
                <p className="text-[#6A7282] text-[11px] md:text-[15px]">
                  {getBlogsInfo.featuredBlog.authorPosition}
                </p>
              </div>
            </div>
